    ...
    <form method="POST" action="<?= BASE_URL ?>productos/crear">
        ...
        <div class="grid-form">
            ...
            <div class="grupo-form completo">
                ...
                <textarea class="input-form" name="descripcion" rows="3" placeholder="Descripción del producto..."></textarea>
            </div>
            ...
            <div class="grupo-form">
                ...
                <input class="input-form" type="number" name="descuento" step="0.01" min="0" max="100" value="0" placeholder="0">
            </div>
        ...
        <div class="form-acciones">
            <a href="<?= BASE_URL ?>productos" class="btn btn-secundario">Cancelar</a>
